...
function resetQueryResWithTotal(res,result,total,errMsg,next){
    res.send(200,{success : true,total:total,result:result,msg:errMsg});
    if (next){
        return next();
    }
}
...
module.exports = {
    ...
    resetQueryResWithTotal:resetQueryResWithTotal,
